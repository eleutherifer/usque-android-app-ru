...
//            if (licenseKeyInput.text.isNullOrBlank()) { toast(tr("Ключ и так не установлен", "No key is set")); return@setOnClickListener }
    ...
    private fun buildConfigPage(): View {
        ...
        profileNameInput = input(tr("Название профиля", "Profile Name"), tr("Например：360tv.ru 443 / 360tv.ru 8443", "e.g. 360tv.ru 443 / 360tv.ru 8443"))
    ...
    private fun loadProfiles() {
        ...
        if (profiles.isEmpty()) {
            profiles["360tv.ru:8443, colo1, auto"] = Profile("360tv.ru", "162.159.198.2", 8443, "auto")
            profiles["360tv.ru:8443, colo2, auto"] = Profile("360tv.ru", "162.159.199.2", 8443, "auto")
            profiles["360tv.ru:500, colo1, auto"] = Profile("360tv.ru", "162.159.198.2", 500, "auto")
            profiles["360tv.ru:500, colo2, auto"] = Profile("360tv.ru", "162.159.199.2", 500, "auto")
            profiles["360tv.ru:443, colo1, auto"] = Profile("360tv.ru", "162.159.198.2", 443, "auto")
            profiles["360tv.ru:443, colo2, auto"] = Profile("360tv.ru", "162.159.199.2", 443, "auto")
            profiles["nplus1.ru:8443, colo1, auto"] = Profile("nplus1.ru", "162.159.198.2", 8443, "auto")
            profiles["nplus1.ru:8443, colo2, auto"] = Profile("nplus1.ru", "162.159.199.2", 8443, "auto")
            profiles["nplus1.ru:500, colo1, auto"] = Profile("nplus1.ru", "162.159.198.2", 500, "auto")
            profiles["nplus1.ru:500, colo2, auto"] = Profile("nplus1.ru", "162.159.199.2", 500, "auto")
            profiles["nplus1.ru:443, colo1, auto"] = Profile("nplus1.ru", "162.159.198.2", 443, "auto")
            profiles["nplus1.ru:443, colo2, auto"] = Profile("nplus1.ru", "162.159.199.2", 443, "auto")
            persistProfiles()
        }
    ...
    private fun saveAsNewProfile() {
        ...
        profiles[name] = Profile(sniInput.text?.toString().orEmpty().ifBlank { "360tv.ru" }, normalizedEndpointHost(), normalizedPort(), transportPolicyFromSpinner())
    ...
    private fun loadSavedState() {
        ...
        sniInput.setText(prefs.getString("sni", "360tv.ru") ?: "360tv.ru")
    ...
    private fun startTunnelNow() {
        val sni = sniInput.text?.toString().orEmpty().ifBlank { "360tv.ru" }
